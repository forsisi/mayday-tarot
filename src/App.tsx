                ...
                {showLyrics && (activeSong.lyrics || apiLyrics) ? (
                  ...
                  <>
                    ...
                    <div onClick={async () => {
                      ...
                      className="absolute w-24 h-24 sm:w-36 sm:h-36 lg:w-44 lg:h-44 rounded-full bg-slate-950 border-[6px] border-slate-900 shadow-xl overflow-hidden flex items-center justify-center cursor-pointer select-none z-20 animate-spin-slow hover:scale-105 transition duration-300"
